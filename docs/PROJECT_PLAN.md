...
- [ ] **다음 내부 정합성 전수조사: 2027-02경** — `/audit`(분기 1회 또는 개정 몰린 뒤 — 이 repo 전용 프로젝트 스킬, 1차·2차 모두 2026-08-12 수행). 예정일이 지나면 /resume가 안내
- [ ] **다음 재검증: 2027-01경** (00 §L, 6개월 주기)
  ...
  - **output-styles 동명 우선순위** — 05:67은 "작업 디렉터리에 가까운 쪽 우선"(2026-08-04 조회), 01:267은 스킬 기준 "enterprise > personal > project"(08-12 재확인). 기능이 달라 둘 다 참일 수 있으나 한쪽만 갱신됐을 가능성 — 공식 문서로 확인 후 표현 통일(2026-08-12 /audit 2차 인계)
