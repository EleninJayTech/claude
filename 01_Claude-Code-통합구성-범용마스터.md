...
> **문서 버전: v1.78** · 최종 갱신: **2026-09-16** · **최근 재검증: 2026-09-16** · 기준: Claude Code v2.1.273 (Opus 5 · Sonnet 5 · Fable 5.1)
>
> | 버전 | 날짜 | 변경 내용 |
> | --- | --- | --- |
...
**문서 정보** — 통합 마스터(범용) **v1.78**. 변경 이력은 최상단 버전 표 참조(유래: 8개 소스 통합 초판 — 최상단 병합 행).
