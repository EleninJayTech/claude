...
| 파일 | 역할 | 버전 |
| --- | --- | --- |
| `00_통합-설치.md` | 01~03 통합 설치 셀렉터 — 문서 확보→감지→선택 목록→해당 문서 프로토콜로 위임 | v1.1 (2026-07-28) |
| `01_Claude-Code-통합구성-범용마스터.md` | 글로벌+프로젝트 셋업 마스터(§D 글로벌·§E 환경별·§F SSOT 블록) | v1.8 (2026-07-28) |
| `02_모델분담-범용-플레이북.md` | 상위/하위 모델 자동 분담, `.claude/agents/` 로스터 템플릿 | v1.7 (2026-07-28) |
| `03_확장기능-설치-체크리스트.md` | 확장 3종(claude-hud·svg-design·frontend-design) 체크리스트 설치 — 감지→확인→선택 설치 | v1.1 (2026-07-28) |
