...
| 파일 | 역할 | 버전 |
| --- | --- | --- |
| `00_Claude-Code-통합구성-범용마스터.md` | 글로벌+프로젝트 셋업 마스터(§D 글로벌·§E 환경별·§F SSOT 블록) | v1.4 (2026-07-20) |
| `01_모델분담-범용-플레이북.md` | 상위/하위 모델 자동 분담, `.claude/agents/` 로스터 템플릿 | v1.3 (2026-07-20) |
| `02_진단-확장활용-가이드.md` | 세션 운영 기법(검증 루프·plan mode·컨텍스트 관리·worktree·헤드리스·MCP) | v1.1 (2026-07-23) |
